...
class CaseObject(SQLAlchemyObjectType):
    ...
    iocs = SQLAlchemyConnectionField(IOCConnection, ioc_id=Int(), ioc_uuid=String(), ioc_value=String(), ioc_type_id=Int(),
                                     ioc_description=String(), ioc_tlp_id=Int(), ioc_pap_id=Int(), ioc_tags=String(), ioc_misp=String(),
                                     user_id=Float())

    # TODO why is kwargs necessary? Should investigate and try to remove
    @staticmethod
    def resolve_iocs(root, info, ioc_id=None, ioc_uuid=None, ioc_value=None, ioc_type_id=None, ioc_description=None, ioc_tlp_id=None, ioc_pap_id=None, ioc_tags=None,
        ...
        return iocs_build_filter_query(ioc_id=ioc_id, ioc_uuid=ioc_uuid, ioc_value=ioc_value,
                                       ...
                                       ioc_tlp_id=ioc_tlp_id, ioc_pap_id=ioc_pap_id, ioc_tags=ioc_tags, ioc_misp=ioc_misp,
                                       user_id=user_id)
